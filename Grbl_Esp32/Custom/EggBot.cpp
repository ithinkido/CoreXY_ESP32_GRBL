...
*/
void machine_init() {
    pinMode(U_step_0, OUTPUT);
    pinMode(U_step_1, OUTPUT);
    pinMode(U_step_2, OUTPUT);

    digitalWrite (U_step_0,HIGH);
    digitalWrite (U_step_1,HIGH);
    digitalWrite (U_step_2,HIGH);
}
/*
